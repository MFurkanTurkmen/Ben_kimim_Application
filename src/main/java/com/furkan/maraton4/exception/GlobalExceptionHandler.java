...
import static com.furkan.maraton4.exception.EErrorType.BAD_REQUEST_ERROR;
import static com.furkan.maraton4.exception.EErrorType.INTERNAL_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(Maraton4Exception.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleSpringMonoException(Maraton4Exception exception){
